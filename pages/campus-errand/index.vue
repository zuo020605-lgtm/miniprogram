<template>
  <view class="campus-errand-page">
    <view class="header">
      <text class="header-title">校园跑腿</text>
    </view>
    <view class="search-section">
      <view class="search-input">
        <Icon name="search" :size="16" color="#9a9da0"></Icon>
        <input type="text" placeholder="搜索跑腿任务..." class="search-text" />
      </view>
    </view>
    <view class="filter-section">
      <view class="filter-item active"><text>全部</text></view>
      <view class="filter-item"><text>取送物品</text></view>
      <view class="filter-item"><text>食堂代买</text></view>
...
export default {
  ...
  data() {
    return {
      tasks: [
        { title: '二教帮拿大件快递到寝', price: 25, location: '燕园二教 -> 32号楼', time: '今天 18:00 前', publisher: '小张' },
        { title: '食堂代买五四麻辣烫', price: 8, location: '五四食堂 -> 45号楼', time: '今天 12:00 前', publisher: '小王' },
        { title: '打印资料并送到图书馆', price: 12, location: '打印店 -> 图书馆南门', time: '今天 14:00 前', publisher: '小刘' }
      ]
    };
  },
  methods: {
